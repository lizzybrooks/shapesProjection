...
void setup(){
  ...
  int index = 0;
  for (int y = 0; y < 4; y++) {
      traps[index++] = new Trap(random(100,120),random(100,120),random(200,220), random(200,220));
  }
...
class Trap extends movingLine{
  
  Trap(float leftX, float leftY, float rightX, float rightY){
